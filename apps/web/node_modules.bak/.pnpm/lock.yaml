...
importers:
  ...
  .:
    dependencies:
      '@moes/curation':
        specifier: file:../../packages/curation
        version: file:../../packages/curation
      '@moes/indexer':
        specifier: file:../../packages/indexer
        version: file:../../packages/indexer
      next:
        specifier: ^14.2.5
...
packages:
  ...
  '@moes/curation@file:../../packages/curation':
    resolution: {directory: ../../packages/curation, type: directory}

  '@moes/indexer@file:../../packages/indexer':
    resolution: {directory: ../../packages/indexer, type: directory}

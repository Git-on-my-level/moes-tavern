...
import type {
  ListingRegistry,
  ListingRegistryInterface,
} from "../../../contracts/ListingRegistry.sol/ListingRegistry";
...
type ListingRegistryConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: ListingRegistryConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class ListingRegistry__factory extends ContractFactory {
  constructor(...args: ListingRegistryConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override getDeployTransaction(
    ...
    return super.getDeployTransaction(identityRegistry_, overrides || {});
  }
  override deploy(
    identityRegistry_: AddressLike,
    overrides?: NonPayableOverrides & { from?: string }
  ) {
    return super.deploy(identityRegistry_, overrides || {}) as Promise<
      ListingRegistry & {
        deploymentTransaction(): ContractTransactionResponse;
      }
    >;
  }
  override connect(runner: ContractRunner | null): ListingRegistry__factory {
    return super.connect(runner) as ListingRegistry__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): ListingRegistryInterface {
    return new Interface(_abi) as ListingRegistryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ListingRegistry {
    return new Contract(address, _abi, runner) as unknown as ListingRegistry;
  }
}
